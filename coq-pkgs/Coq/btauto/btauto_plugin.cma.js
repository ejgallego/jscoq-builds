...
g=246,ab="core.bool.type",O=142,aa="to_list",$="btauto",j=250,n=bg.jsoo_runtime,o=n.caml_check_bound,b=n.caml_new_string,i=n.caml_obj_tag,S=n.caml_register_global,_=n.caml_wrap_exception;function
...
c=a(T[2],b);return a(ac[15],c)}]}function
B(d,b){var
e=a(p[9],b),f=c(ad[56],d,e),g=a(p[O][1],f);return a(u[30],g)}function
l(b,d){var
c=i(b),e=j===c?b[1]:g===c?a(h[2],b):b;return a(u[16],[0,e,d])}var
k=u[81],v=e(ae),w=e(af);function
U(b,a){if(a){var
...
D=a(al[25],[0,u[81],u[114]]);function
P(a,b){var
d=a[2],e=a[1];try{var
g=c(D[7],e,b);return g}catch(a){a=_(a);if(a===am){var
f=d[1];A(D[5],e,b,f);d[1]++;return f}throw a}}var
F=[g,function(c){var
b=a(T[2],an);return a(ao[8],b)}],q=e(ap),r=e(aq),s=e(ar),G=e(as),H=e(at),I=e(au),J=e(av);function
W(m,t,q){var
...
13:var
n=f[4],A=f[3],C=f[1][1],p=i(F),D=j===p?F[1]:g===p?a(h[2],F):F;if(c(ay[43],C,D)){var
...
f=e[1],g=e[2]?a(d[3],a0):a(d[3],a3),h=a(x[5],b),i=a(x[2],b),j=A(a1[6],h,i,f),k=a(d[13],0),l=a(d[3],a2),m=a(d[13],0),n=c(d[12],j,m),o=c(d[12],n,l),p=c(d[12],o,k);return c(d[12],p,g)},J=c(E[17],I,H),K=a(d[3],a4),L=a(d[13],0),M=a(d[3],a5),N=F(c(d[12],M,L),J),P=a(d[3],a6),R=c(d[12],P,N),S=c(d[12],R,K),T=a(d[13],0),U=a(d[3],a7),V=c(d[12],U,T),W=c(d[12],V,S),f=W}catch(b){b=_(b);if(!a(aY[13],b))throw b;var
f=a(d[3],aZ)}return A(y[19],0,f,b)}function
a9(o){var
P=a(z[67][1],o),Q=a(p[O][1],P),l=a(x[32][3],o),r=i(t),R=j===r?t[1]:g===r?a(h[2],t):t,s=i(q),S=j===s?q[1]:g===s?a(h[2],q):q,m=B(l,Q);if(9===m[0]){var
b=m[2];if(3===b.length-1){var
v=m[1],w=b[1],U=b[2],V=b[3];if(c(k,w,S))if(c(k,v,R)){var
e=[0,a(D[1],16),[0,1]],Y=W(e,l,U),Z=W(e,l,V),F=e[1],G=function(c,b,a){return[0,[0,b,c],a]},H=A(D[14],G,F,0),I=function(b,a){return n.caml_int_compare(b[1],a[1])},J=c(E[48],I,H),K=function(a){return a[2]},f=c(E[17],K,J),_=X(f,Y),$=[0,v,[0,w,_,X(f,Z)]],aa=a(u[16],$),ab=a(p[9],aa),ac=0,L=function(e){var
n=a(z[67][1],e),l=i(t),o=j===l?t[1]:g===l?a(h[2],t):t,q=a(p[O][1],n),b=B(a(x[32][3],e),q);if(9===b[0]){var
m=b[2];if(3===m.length-1){var
s=m[2];if(c(k,b[1],o)){var
u=function(a){return aT(s,f,a)},v=c(z[71][1],0,u);return c(y[57][11],N[123],v)}}}var
r=a(d[3],a8);return c(y[57][4],0,r)},ad=[0,a(z[67][7],L),ac],ae=[0,N[68],ad],C=i(M),af=j===C?M[1]:g===C?a(h[2],M):M,ag=a(p[9],af),ah=[0,a(N[87],ag),ae],ai=[0,a(N[54],ab),ah];return a(y[57][22],ai)}}}var
T=a(d[3],a_);return c(y[57][4],0,T)}var
Z=[0,a(z[67][7],a9)];S(65,[0,Z],"Btauto_plugin__Refl_btauto");a(a$[9],R);var

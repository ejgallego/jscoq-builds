...
s=246,P="Ascii",O="ascii",N=250,d=ad.jsoo_runtime,L=d.caml_ml_string_length,c=d.caml_new_string,K=d.caml_obj_tag,M=d.caml_register_global,n=d.caml_string_get,ac=d.caml_wrap_exception;function
...
a=d.caml_get_global_data(),o=c("ascii_syntax_plugin"),j=[0,c("Coq"),[0,c("Strings"),[0,c(P),0]]],q=c("char_scope"),t=a.Mltop,h=a.Util,k=a.Coqlib,i=a.DAst,C=a.CamlinternalLazy,g=a.Names,I=a.Notation,ab=a.Option,aa=a.Stdlib,$=a.Stdlib__printf,X=a.Pp,Z=a.CErrors,R=a.Libnames,Q=a.Globnames;b(t[10],o);var
l=[248,c("Ascii_syntax.Non_closed_ascii"),d.caml_fresh_oo_id(0)],_=[0,[4,0,[0,2,3],0,0],c("%03d")],W=c("Expects a single character or a three-digits ascii code."),Y=[0,c("interp_ascii_string")],V=c(P),U=c("Ascii interpretation"),S=c(O),T=c(O);function
p(a){var
...
d=K(f),h=c(8,g),j=0,l=N===d?f[1]:s===d?b(C[2],f):f,m=[4,e(i[3],a,[0,l,j]),h];return e(i[3],a,m)}function
D(f,a){if(1===L(a))var
...
d=K(f),g=c[2],h=c[1],j=N===d?f[1]:s===d?b(C[2],f):f;if(m(h,j))return a(8,g)}throw l}(c)];return d}catch(a){a=ac(a);if(a===l)return 0;throw a}}function

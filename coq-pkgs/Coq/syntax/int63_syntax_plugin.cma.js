...
k=e(g[28],0,a("Coq.Numbers.Cyclic.Int63.Int63.int")),l=e(g[28],0,a("Coq.Numbers.Cyclic.Int63.Int63.id_int")),x=[0,0,1],y=[0,0,1],u=a("int");function
m(a){var
...
a=c(w[12],l);return c(z[23],[0,0,p,[1,[0,y,a,x,a,k,0]],[0,o,i],0,0])},v);r(15,[0,f,k,l,m,n,i,o,p,q],"Int63_syntax_plugin__Int63_syntax");return}

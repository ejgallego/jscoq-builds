...
$="zn2z",H="BigN",aK="Cyclic",n="Numbers",aJ="t_",aI="int31",aH="digits",G="BigZ",F="BigQ",_="t",aG="Int31",m="Coq",h=ba.jsoo_runtime,a=h.caml_new_string,aF=h.caml_register_global,D=h.caml_wrap_exception;function
d(a,b){return a.length==1?a(b):h.caml_call_gen(a,[b])}function
b(a,b,c){return a.length==2?a(b,c):h.caml_call_gen(a,[b,c])}function
aE(a,b,c,d){return a.length==3?a(b,c,d):h.caml_call_gen(a,[b,c,d])}function
E(a,b,c,d,e){return a.length==4?a(b,c,d,e):h.caml_call_gen(a,[b,c,d,e])}var
e=h.caml_get_global_data(),aa=a("numbers_syntax_plugin"),q=[0,a(m),[0,a(n),[0,a(aK),[0,a(aG),[0,a(aG),0]]]]],ad=a("int31_scope"),M=[0,a(m),[0,a(n),[0,a(aK),[0,a("DoubleCyclic"),[0,a("DoubleType"),0]]]]],u=[0,a(m),[0,a(n),[0,a("Natural"),[0,a(H),[0,a(H),0]]]]],ag=a("bigN_scope"),v=[0,a(m),[0,a(n),[0,a("Integer"),[0,a(G),[0,a(G),0]]]]],aj=a("bigZ_scope"),y=[0,a(m),[0,a(n),[0,a("Rational"),[0,a(F),[0,a(F),0]]]]],am=a("bigQ_scope"),g=e.Globnames,c=e.Bigint,l=e.Loc,k=e.Pervasives,ao=e.Pp,ap=e.CErrors,ab=e.List,i=e.Names,A=e.Notation,a9=e.Nat_syntax_plugin,aL=e.Libnames;d(e.Mltop[12],aa);var
a_=a("bigN are only non-negative numbers."),a$=[0,a("interp_bigN")],a7=a("int31 are only non-negative numbers."),a8=[0,a("interp_int31")],aM=a(aI),aN=a(aI),aO=a(aH),aP=a(aH),aQ=a($),aS=a($),aT=a($),aU=a(_),aV=[0,a(H),0],aW=a("t'"),aX=a(H),aY=a(_),aZ=[0,a(G),0],a0=a(aJ),a1=a(G),a2=a(_),a3=[0,a(F),0],a4=a(aJ),a5=a(F),a6=a("Numbers_syntax.Non_closed");function
o(a){var
c=b(ab[15],i[1][6],a);return d(i[5][4],c)}function
j(c,a){var
e=d(i[1][6],a),f=o(c);return b(aL[17],f,e)}function
I(c,a){var
...
s=[3,[0,[0,r(aN),0],1]],K=[3,[0,[0,r(aO),0],1]],L=[3,[0,[0,r(aP),0],2]],aR=j(M,aQ);function
N(a){return J(M,a)}var
O=[3,[0,[0,N(aS),0],1]],t=[3,[0,[0,N(aT),0],2]],ae=j(b(k[22],u,aV),aU),af=p(u,aX,aW),ah=7;function
P(a){return[3,[0,[0,af,0],b(k[4],a,ah)+1|0]]}var
ai=j(b(k[22],v,aZ),aY),Q=p(v,a1,a0),w=[3,[0,[0,Q,0],1]],x=[3,[0,[0,Q,0],2]],ak=j(b(k[22],y,a3),a2),al=p(y,a5,a4),z=[3,[0,[0,al,0],1]],f=[248,a6,h.caml_fresh_oo_id(0)];function
R(a,e){var
...
an(a){var
b=d(ao[3],a7);return aE(ap[6],[0,a],a8,b)}function
...
h=[0,g,0];else
var
j=d(c[3],e-7|0),h=[0,b(a9[1][4],a,j),[0,g,0]];return[4,a,i,h]}function
av(a){var
b=d(ao[3],a_);return aE(ap[6],[0,a],a$,b)}function
...
aD=[0,aa,o,j,I,J,p,q,ac,r,ad,s,K,L,M,aR,N,O,t,u,ae,af,ag,ah,P,v,ai,Q,aj,w,x,y,ak,al,am,z,f,R,an,aq,S,ar,T,U,as,at,au,B,av,aw,X,C,ax,az,Y,Z,aA,aB,aC];aF(46,aD,"Numbers_syntax_plugin.Numbers_syntax");aF(47,[0,aD],"Numbers_syntax_plugin");return});

...
bI=617,bD=145,bE="eqTLR",ax="Rmult",aA="R0",aB="Ropp",Y="Rle",az="Rminus",bC="fourier_plugin",bB="eqTRL",X="Rlt",e=246,bH="Fourier",aj="fourier",$="Rge",bA="plugins/fourier/fourier.ml",Q=120,aw="plugins/fourier/fourierR.ml",_="Rgt",av="Rplus",K=136,Z=248,au="Rinv",bz="R",bG="Reals",by=147,ay="R1",bF="Rdiv",o=dG.jsoo_runtime,j=o.caml_check_bound,bx=o.caml_div,W=o.caml_fresh_oo_id,s=o.caml_mul,b=o.caml_new_string,ai=o.caml_register_global,h=o.caml_string_notequal,F=o.caml_wrap_exception;function
...
dF(a,b,c,d,e){return a.length==4?a(b,c,d,e):o.caml_call_gen(a,[b,c,d,e])}var
m=o.caml_get_global_data(),z=[0,0,1],aD=[0,1,1],ah=b(bC),R=m.Assert_failure,l=m.List,G=m.Pervasives,q=m.Term,f=m.Tactics,g=m.Tacticals,P=m.Proofview,I=m.Coqlib,M=m.Names,bs=m.CErrors,bt=m.Equality,aq=m.Array,bv=m.Ltac_plugin,bu=m.Mltop,bS=[0,b(bA),176,9],bQ=[0,b(bA),by,9],bO=b("empty ineq"),bK=b("/"),bR=b("Fourier.Contradiction"),bX=b("not_of_constant"),bZ=b(bF),b0=b(au),b1=b(az),b2=b(ax),b3=b(aB),b4=b(av),b5=b(aA),b6=b(ay),b8=b(bF),b9=b(au),b_=b(az),b$=b(ax),ca=b(aB),cb=b(av),cc=b(aA),cd=b(ay),dl=[0,b("Coq"),[0,b(aj),[0,b(bH),0]]],dn=b("new_hyp_for_fourier"),du=b($),dv=b(_),dw=b(Y),dx=b(X),dp=b("No inequalities"),dq=b("fourier failed"),dt=[0,b(aw),bI,11],dr=[0,b(aw),bI,30],dd=b($),de=b(_),df=b(Y),dg=b(X),dh=b(bE),di=b(bB),dj=[0,b(aw),426,6],db=b("Rlt_not_le_frac_opp"),da=b("Rnot_le_le"),c$=b("Rnot_lt_lt"),c_=b("Rfourier_le_le"),c9=b("Rfourier_le_lt"),c8=b("Rfourier_lt_le"),c7=b("Rfourier_lt_lt"),c6=b("Rfourier_le"),c5=b("Rfourier_lt"),c4=b("Rfourier_not_lt_ge"),c3=b("Rfourier_not_le_gt"),c2=b("Rfourier_not_gt_le"),c1=b("Rfourier_not_ge_lt"),c0=b("Rfourier_eqRL_to_le"),cZ=b("Rfourier_eqLR_to_le"),cY=b("Rfourier_ge_to_le"),cX=b("Rfourier_gt_to_lt"),cW=b("Rle_not_lt"),cV=b("Rnot_lt0"),cU=b("Rle_mult_inv_pos"),cT=b("Rle_zero_1"),cS=b("Rle_zero_zero"),cR=b("Rlt_mult_inv_pos"),cQ=b("Rle_zero_pos_plus1"),cP=b("Rlt_zero_pos_plus1"),cO=b("Rlt_zero_1"),cL=b("Rinv_1"),cM=[0,b(bG),[0,b("RIneq"),0]],cK=b(ay),cJ=b(aA),cI=b(au),cH=b(aB),cG=b(av),cF=b(ax),cE=b(az),cC=b(bz),cA=b($),cz=b(Y),cx=b(_),cw=b(X),cg=b($),ch=b(_),ci=b(Y),cj=b(X),ck=b(X),cl=b(Y),cm=b(_),cn=b($),cp=b(bz),cq=b(bB),cr=b(bE),bV=b("Coq.Reals.Rdefinitions"),bW=b("constant_not_of_R"),bY=b("FourierR.NoRational"),b7=b("FourierR.NoLinear"),cf=b("FourierR.NoIneq"),ct=b(bH),cv=[0,b(bG),[0,b("Rdefinitions"),0]],cN=[0,b(aj),[0,b("Fourier_util"),0]],dk=b("FourierR.GoalDone"),dA=b(aj),dC=b("fourierz"),dy=b(bC),dE=b(aj),bP=m.Failure,dm=m.Termops,ds=m.Contradiction,cs=m.CamlinternalLazy,co=m.Globnames,bU=m.Not_found,bT=m.Hashtbl,dB=m.Loc;function
...
r=a(bT[18],[0,q[132],q[by]]);function
t(c){var
...
p(k){var
f=k;for(;;){var
e=a(q[K],f);switch(e[0]){case
5:var
f=e[1];continue;case
9:var
b=e[2],d=ab(e[1]);if(h(d,bZ)){if(h(d,b0)){if(h(d,b1)){if(h(d,b2)){if(h(d,b3)){if(h(d,b4))throw C;var
l=p(j(b,1)[2]),m=p(j(b,0)[1]);return c(i[7],m,l)}var
n=p(j(b,0)[1]);return a(i[6],n)}var
o=p(j(b,1)[2]),r=p(j(b,0)[1]);return c(i[9],r,o)}var
s=p(j(b,1)[2]),t=p(j(b,0)[1]);return c(i[8],t,s)}var
u=p(j(b,0)[1]);return a(i[10],u)}var
v=p(j(b,1)[2]),w=p(j(b,0)[1]);return c(i[11],w,v);case
10:var
g=L(e[1][1]);if(h(g,b5)){if(h(g,b6))throw C;return i[4]}return i[3];default:throw C}}}var
S=[Z,b7,W(0)];function
n(k){try{var
f=a(q[K],k);switch(f[0]){case
5:var
g=n(f[1]);break;case
9:var
...
try{var
l=p(j(b,0)[1]);try{var
G=p(j(b,1)[2]),H=c(i[9],l,G),I=w(t(0),H),m=I}catch(a){a=F(a);if(a!==C)throw a;var
E=j(b,1)[2],m=v(t(0),E,l)}var
d=m}catch(a){a=F(a);if(a!==C)throw a;var
A=p(j(b,1)[2]),D=j(b,0)[1],d=v(t(0),D,A)}else
var
J=n(j(b,1)[2]),d=B(n(j(b,0)[1]),J);else
var
M=p(j(b,0)[1]),N=a(i[10],M),d=w(t(0),N);else{var
o=p(j(b,1)[2]);try{var
Q=p(j(b,0)[1]),R=c(i[11],Q,o),T=w(t(0),R),r=T}catch(c){c=F(c);if(c!==C)throw c;var
...
D=[Z,cf,W(0)];function
aQ(o){var
e=o[1],l=a(q[K],o[2]);if(9===l[0]){var
f=l[2],m=a(q[K],l[1]);switch(m[0]){case
10:var
...
11:var
p=m[1][1];if(1-c(co[5],[2,[0,p[1],p[2]]],I[30]))throw D;var
x=j(f,0)[1],i=j(f,1)[2],k=j(f,2)[3],r=a(q[K],x);if(10===r[0]){if(h(L(r[1][1]),cp))throw D;var
...
c=h;for(;;){var
k=b[1],l=[0,d(T),k],m=[0,d(ad),l];b[1]=a(q[Q],m);var
n=c+1|0;if(g!==c){var
c=n;continue}break}}if(0<=e)return b[1];var
i=[0,b[1]],j=[0,d(aY),i];return a(q[Q],j)}function
O(c){var
b=x(c),e=b[1],f=[0,as(b[2])],g=[0,d(ar),f],h=a(q[Q],g),i=[0,as(e),h],j=[0,d(N),i];return a(q[Q],j)}function
E(D,j){var
...
y(c){var
b=a(aq[11],c),d=a(l[4],b),e=a(aq[12],d),f=[0,a(l[3],b),e];return a(q[Q],f)}var
ag=[Z,dk,W(0)];function
U(e){var
b=[0,function(b){var
Z=a(P[63][3],b);a(I[11],dl);var
_=a(dm[67],Z),n=a(M[1][6],dn);try{var
Y=a(q[K],_);if(9===Y[0]){var
v=ab(Y[1]);if(h(v,du))if(h(v,dv))if(h(v,dw)){if(h(v,dx))throw ag;var
bw=U(0),bx=a(f[22],n),by=d(ba),bz=a(f[85],by),bA=c(g[70][3],bz,bx),w=c(g[70][3],bA,bw)}else
var
bB=U(0),bC=a(f[22],n),bE=d(bb),bF=a(f[85],bE),bG=c(g[70][3],bF,bC),w=c(g[70][3],bG,bB);else
var
bH=U(0),bI=a(f[22],n),bJ=d(bc),bK=a(f[85],bJ),bL=c(g[70][3],bK,bI),w=c(g[70][3],bL,bH);else
var
bM=U(0),bN=a(f[22],n),bO=d(bd),bP=a(f[85],bO),bQ=c(g[70][3],bP,bN),w=c(g[70][3],bQ,bM);return w}throw ag}catch(h){h=F(h);if(h===ag){var
$=br(a(P[63][4],b)),aa=function(b){var
c=b[2];return[0,a(q[109],b[1]),c]},m=[0,0],ac=c(l[13],aa,$),ae=function(a){try{var
b=m[1],d=aQ(a);m[1]=c(G[22],d,b);var
e=0;return e}catch(a){a=F(a);if(a===D)return 0;throw a}};c(l[11],ae,ac);if(0===m[1])a(bs[7],dp);var
p=aR(m[1]),r=[0,a(P[13],0)];if(0===p)a(bs[7],dq);else{if(p)if(p[2])var
H=0;else{var
z=p[1],L=z[2],A=z[1],B=[0,0],af=c(l[40],m[1],z[3]),ah=function(a){var
b=a[2],c=o.caml_notequal(b,i[3]),d=a[1],e=c?(B[1]=[0,[0,d,b],B[1]],0):c;return e};c(l[11],ah,af);var
C=B[1];if(!C)throw[0,R,dt];var
...
e=d(a0),h=a(f[85],e),i=a(f[85],b);return c(g[70][3],i,h)},aC=d(aS),aD=[0,c(g[70][58],aC,aB),aA],aE=a(P[13],0),aF=a(P[13],0),aG=[0,c(g[70][12],aF,aE),aD],aH=d(T),aI=[0,d(T)],aJ=[0,d(ar),aI],aK=a(q[Q],aJ),aL=c(bt[12],aK,aH),aM=[0,ax,[0,c(g[70][19],aL,aG),az]],aN=t[1],aO=u[1],aP=y([0,d(aX),aO,aN]),aY=c(bt[12],aP,aq),aZ=c(g[70][19],aY,aM),a1=L?d(bk):d(bl),a2=a(f[85],a1),a3=c(g[70][3],a2,aZ),a4=y([0,d(aU),W]),a5=a(f[52],a4),a6=[0,c(g[70][3],a5,a3),ay],a7=a(f[bD],W);r[1]=c(g[70][19],a7,a6);var
a8=[0,r[1],0],a9=a(ds[2],0),a_=[0,c(g[70][3],f[16],a9),a8],a$=d(aT),bm=a(f[bD],a$);r[1]=c(g[70][19],bm,a_);var
H=1}else
var
H=0;if(!H)throw[0,R,dr]}return r[1]}throw h}}];return a(P[63][9],b)}var
at=[0,r,t,aM,v,w,aN,aO,B,aP,L,ab,C,p,S,n,ce,D,aQ,aR,d,ac,aS,aT,aU,cu,u,aV,cy,aW,cB,cD,aX,N,ad,aY,ar,aZ,T,a0,k,ae,af,a1,a2,a3,a4,a5,a6,a7,a8,a9,a_,a$,ba,bb,bc,bd,be,bf,bg,bh,bi,bj,bk,bl,bm,dc,x,as,O,E,bn,bo,bp,bq,J,br,y,ag,U];ai(126,at,"Fourier_plugin.FourierR");a(bu[12],dy);function
dz(d){var
b=[28,[0,0,[31,dB[4],[0,[0,ah,dA],0],0]]],c=a(M[1][6],dC);return dF(bv[6][4],1,0,c,b)}var
dD=[0,function(c,b){return a(at[80],0)}];V(bv[6][9],0,[0,ah,dE],dD);c(bu[19],dz,ah);var
bw=[0,ah];ai(130,bw,"Fourier_plugin.G_fourier");ai(131,[0,i,at,bw],"Fourier_plugin");return});

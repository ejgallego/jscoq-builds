...
kB=" :: ",bJ="module ",es=";",lh="i",ch=",",kK="functor (",k6="expr:lambda",kz="JSON",gC="=",kA=".\n",c$="_vendor+v8.10+32bit/coq/plugins/extraction/table.ml",ez="(",k5=") ->",kJ="Haskell",eH="_vendor+v8.10+32bit/coq/plugins/extraction/haskell.ml",kI='Prelude.error "EXTRACTION OF UINT NOT IMPLEMENTED"',k4="Compilation of file ",eu="]",gQ="=>",gP="(* ",k3="Cannot mix yet user-given match and general patterns.",ky=906,gJ=495,kH=904,k2="Print",eG="_vendor+v8.10+32bit/coq/plugins/extraction/scheme.ml",gY="#else",N="_vendor+v8.10+32bit/coq/plugins/extraction/extraction.ml",eF=" ->",bp=248,k1="Coq.Init.Specif",k0="match ",gX="| ",kG="Constant",kF="items",kZ="if",kx="define ",kw="->",kY=": ",eE="UNUSED",lg="error",ap=" = ",lf="of",c8=121,ey="[",gO="'",kX="Close it and try again.",eD=108,C="Extraction",kE="unsafeCoerce :: a -> b",bo="extraction",Y="name",c_="_vendor+v8.10+32bit/coq/plugins/extraction/ocaml.ml",er=103,av=120,kW=" : logical inductive",V="__",gN=102,kv="unit",gI="args",le=" (* AXIOM TO BE REALIZED *)",gW="-- HUGS",ku=132,da="body",kD="case",a4="  ",lc="do",ld="Any",kt="struct",c7="end",gH="#endif",kV="Reset",gG=" *)",ex="module type ",kU="else",db="}",et="in",eC="type",gB="Coq_",a3=107,la="force",lb=" }",gV="module",a2="_vendor+v8.10+32bit/coq/plugins/extraction/mlutil.ml",kT="match",gU=143,gM="#ifdef __GLASGOW_HASKELL__",c6="argnames",br="_vendor+v8.10+32bit/coq/plugins/extraction/extract_env.ml",u="what",ks="for",cg=109,gT=126,gL="in ",bn="type ",ai="",k$="then",gS="let ",eq="and ",ah=" =",gF="Inline",kS="OCaml",ep="sig",c5="_vendor+v8.10+32bit/coq/plugins/extraction/modutil.ml",k_=" end",kR="with constructors : ",aq=".",eB=" :",gR=".ml",kQ="unsafeCoerce",kr="class",kC=523,kP="Recursive",gE="Blacklist",gK="Extract",k9="Scheme",aj="_vendor+v8.10+32bit/coq/plugins/extraction/common.ml",ew="false",kq="let {",kp="Library",kO=106,X=" ",c9=")",gD="let",ko=" with",kN=":",kM="let rec ",eA="value",bq="_",kL="as",k8="singleton inductive, whose constructor was ",ev="true",k7="_vendor+v8.10+32bit/coq/plugins/extraction/json.ml",E=DO.jsoo_runtime,i=E.caml_check_bound,bl=E.caml_fresh_oo_id,km=E.caml_int_compare,c4=E.caml_list_of_js_array,bm=E.caml_make_vect,cf=E.caml_ml_string_length,d=E.caml_new_string,ag=E.caml_register_global,aa=E.caml_string_get,ao=E.caml_string_notequal,DN=E.caml_trampoline,gz=E.caml_trampoline_return,kn=E.caml_update_dummy,l=E.caml_wrap_exception;function
...
eI=v[1],eJ=v[2],eK=c(v[36],2),gZ=v[3],g0=v[6],eL=v[9],g1=v[11],eM=v[14],ci=v[22],g2=v[23],eN=v[24],eO=v[25],lL=d("get_nth_label: not enough MPdot"),oM=[0,d(c$),764,11],oD=d(" is not a valid argument number for "),oE=d(" for "),oF=d("No argument "),ot=d(a4),or=d(a4),os=d("Extraction NoInline:"),ou=d("Extraction Inline:"),nT=d(C),nU=d("Extraction "),nR=d(" has been created by extraction."),nS=d("The file "),nP=d(" first."),nQ=d("Please load library "),nI=d("but this code is potentially unsafe, please review it manually."),nJ=d("Extraction SafeImplicits is unset, extracting nonetheless,"),nK=d(aq),nL=d("At least an implicit occurs after extraction : "),nC=d("the extraction of unsafe code and review it manually."),nD=d("You might also try Unset Extraction SafeImplicits to force"),nE=d("Please check your Extraction Implicit declarations."),nF=d(aq),nG=d("An implicit occurs after extraction : "),nw=d(ai),nx=d(") "),ny=d(ez),nB=d(ai),nz=d("of "),nA=d(" argument "),nm=d("asked"),nv=d("required"),nn=d("extract some objects of this module or\n"),nu=d(ai),no=d("use (Recursive) Extraction Library instead.\n"),np=d("Please "),nq=d("Monolithic Extraction cannot deal with this situation.\n"),nr=d(kA),ns=d(".v as a module is "),nt=d("Extraction of file "),nj=d("Use Recursive Extraction to get the whole environment."),nk=d("For example, it may be inside an applied functor.\n"),nl=d(" is not directly visible.\n"),ni=d("No Scheme modular extraction available yet."),ng=d("not found."),nh=d("Module"),m8=d(" (or in its mutual block)"),m9=d(gL),m_=d("or extract to Haskell."),m$=d("Instead, use a sort-monomorphic type such as (True /\\ True)\n"),na=d("The Ocaml extraction cannot handle this situation yet.\n"),nb=d("has logical parameters, such as (I,I) : (True * True) : Prop.\n"),nc=d("This happens when a sort-polymorphic singleton inductive type\n"),nd=d(aq),ne=d(" has a Prop instance"),nf=d("The informative inductive type "),m4=d("This situation is currently unsupported by the extraction."),m5=d("some Declare Module outside any Module Type.\n"),m6=d(" has no body, it probably comes from\n"),m7=d("The module "),m0=d("This is not supported yet. Please do some renaming first."),m1=d(" have the same ML name.\n"),m2=d(" and "),m3=d("The Coq modules "),mZ=d("Not the right number of constructors."),mY=d("is not an inductive type."),mX=d(" is not a constant."),mS=d(" contains __ which is reserved for the extraction"),mT=d("The identifier "),mP=d(kX),mQ=d("You can't do that within a section."),mN=d(kX),mO=d("You can't do that within a Module Type."),mI=d("In case of problem, close it first."),mJ=d("Extraction inside an opened module is experimental."),mE=d(" type variable(s)."),mF=d("needs "),mG=d("The type scheme axiom "),mv=d("fully qualified name."),mw=d("First choice is assumed, for the second one please use "),mx=d(" ?"),my=d(" or object "),mz=d("do you mean module "),mA=d(" is ambiguous, "),mB=d("The name "),mn=d('If necessary, use "Set Extraction AccessOpaque" to change this.'),mo=d(aq),mp=d("the following opaque constants have been extracted as axioms :"),mq=d("The extraction now honors the opacity constraints by default, "),mg=d(aq),mh=d("the following opaque constant bodies have been accessed :"),mi=d("The extraction is currently set to bypass opacity, "),l7=d("axiom was"),mb=d("axioms were"),l8=d("may lead to incorrect or non-terminating ML terms."),l9=d("Having invalid logical axiom in the environment when extracting"),l_=d(kA),l$=d(" encountered:"),ma=d("The following logical "),lY=d("axiom"),l2=d("axioms"),lZ=d(aq),l0=d(" must be realized in the extracted code:"),l1=d("The following "),lW=[0,d(C)],lV=d(aq),lS=[0,d(c$),292,11],lT=d(aq),lR=d("Inductive object unknown to extraction and not globally visible."),lO=d("_rec"),lP=d("_rect"),lN=[0,d(c$),170,11],lM=[0,d(c$),157,11],lK=[0,d(c$),60,9],l3=d(bo),l4=d("extraction-axiom-to-realize"),mc=d(bo),md=d("extraction-logical-axiom"),mj=d(bo),mk=d("extraction-opaque-accessed"),mr=d(bo),ms=d("extraction-opaque-as-axiom"),mC=d(bo),mD=d("extraction-ambiguous-name"),mK=d(bo),mL=d("extraction-inside-module"),mU=d(bo),mV=d("extraction-reserved-identifier"),nM=d(bo),nN=d("extraction-remaining-implicit"),nV=d("AccessOpaque"),nW=d("AutoInline"),nX=d("TypeExpand"),nY=d("KeepSingleton"),n1=[0,d(C),[0,d("Optimize"),0]],n2=d("Extraction Optimize"),n5=[0,d(C),[0,d("Flag"),0]],n6=d("Extraction Flag"),n9=[0,d(C),[0,d("Conservative"),[0,d("Types"),0]]],n_=d("Extraction Conservative Types"),oa=d(ai),oc=[0,d(C),[0,d("File"),[0,d("Comment"),0]]],od=d("Extraction File Comment"),of=d("ExtrLang"),oi=d("Extraction Lang"),ol=d("ExtrInline"),op=d("Extraction Inline"),ox=d("Reset Extraction Inline"),oA=d("SafeImplicits"),oC=d("ExtrImplicit"),oI=d("Extraction Implicit"),oL=d("ExtrBlacklist"),oP=d("Extraction Blacklist"),oU=d("Reset Extraction Blacklist"),oY=d("ExtrCustom"),oZ=d("ExtrCustomMatchs"),o2=d("ML extractions"),o6=d("ML extractions custom matches"),px=[0,d(a2),708,13],pK=[2,1],pL=[0,d(a2),1163,9],pN=[0,1],pP=[0,1],pQ=[0,1],pV=[0,d(a2),1507,48],pJ=[0,d(a2),1045,10],pH=[0,[11,d("program_branch_"),[4,0,0,0,[10,0]]],d("program_branch_%d%!")],pv=[0,d(a2),699,13],pt=[0,d(a2),637,15],pp=[0,d(a2),353,11],po=[0,d(a2),354,11],pq=[5,1],pn=[0,1],pg=[0,d(a2),169,4],o_=d("Extraction_plugin.Mlutil.Found"),o$=d("Extraction_plugin.Mlutil.Impossible"),pa=d("x"),pb=d(bq),pT=d("Extraction_plugin.Mlutil.Toplevel"),pX=[0,d("Coq.Init.Wf.well_founded_induction_type"),[0,d("Coq.Init.Wf.well_founded_induction"),[0,d("Coq.Init.Wf.Acc_iter"),[0,d("Coq.Init.Wf.Fix_F"),[0,d("Coq.Init.Wf.Fix"),[0,d("Coq.Init.Datatypes.andb"),[0,d("Coq.Init.Datatypes.orb"),[0,d("Coq.Init.Logic.eq_rec_r"),[0,d("Coq.Init.Logic.eq_rect_r"),[0,d("Coq.Init.Specif.proj1_sig"),0]]]]]]]]]],p8=d(ai),p9=[0,d(aj),gN,10],qV=d(gO),qW=d(gO),qT=[0,d(aj),647,11],qU=[0,d(aj),649,49],qS=d("char"),qR=d("Prelude.Char"),qN=[0,d(aj),589,2],qL=d(bq),qK=d(aq),qM=[0,d(aj),579,10],qJ=[0,d(aj),550,10],qI=[0,d(aj),532,2],qH=[0,d(aj),kC,10],qG=[0,d(aj),519,5],qE=[0,d(ai),0],qD=d(ai),qz=[0,d(ai),0],qw=[0,d(aj),380,6],qv=[0,d(aj),381,6],qx=d(V),qy=d(ai),qs=d(ai),qt=d(bq),qu=d("Coq"),qr=d(gB),qo=d(gB),qp=d("coq_"),qn=d("Coq__"),ql=[0,d(aj),295,53],qk=[0,d(aj),283,14],qj=d("get_mpfiles_content"),qa=[0,d(aj),118,2],qb=d(gB),p7=d(X),p6=d(ch),p5=d(ch),p4=d(ch),p2=d(X),p3=d(X),p0=d(c9),p1=d(ez),p_=d(aq),p$=d(V),qO=d("ascii"),qP=d("Coq.Strings.Ascii"),q1=[0,1],q3=[0,0,0],q4=[0,1],q6=[5,1],q8=[0,d(N),355,48],q7=[0,d(N),351,27],q9=[0,d(N),309,19],q_=[5,0],ra=[0,d(N),272,8],q$=[5,0],rb=[0,d(N),269,12],rd=[0,d(N),kC,10],re=[0,d(N),508,1],rh=[0,d(N),694,33],ri=[0,d(N),693,15],rj=[0,d(N),724,11],rl=[9,d("Proj Args")],rk=[0,[10,1],0],rm=[0,d(N),832,8],rn=[0,d(N),817,2],rq=[5,1],rp=[0,1],ru=[0,d(N),859,2],ro=[9,d("absurd case")],rr=[0,d(N),872,1],rt=[0,d(N),kH,3],rs=[0,d(N),ky,3],rH=[0,[10,1],[5,1]],rG=[0,[10,0],[5,0]],rF=[5,1],rE=[0,[5,0]],rC=[5,1],rD=[10,1],rB=[5,0],rz=[0,d(N),1081,85],rA=[0,d(N),1077,12],ry=[0,d(N),1070,32],rv=[5,1],rw=[10,1],qX=d("Extraction_plugin.Extraction.I"),qZ=d("Extraction_plugin.Extraction.NotDefault"),si=d(ld),sj=d("() -- AXIOM TO BE REALIZED"),sk=d(kw),sl=d(ep),sm=d(k1),sn=d("a"),sp=d("()"),so=[0,d(eH),eD,27],sq=d('Prelude.error "AXIOM TO BE REALIZED"'),sr=d(V),ss=d(db),st=d(ap),su=d(kq),sv=d(et),sw=[0,d(eH),172,8],sx=[0,d(eH),183,8],sy=d(k3),sz=d(" of {"),sA=d("case "),sB=d("Prelude.error"),sC=d(ai),sE=d(V),sD=d(V),sF=d(kQ),sG=d(kI),sH=d(bq),sI=d(eF),sJ=d(X),sK=d(db),sL=d(es),sO=d(es),sM=d(gL),sN=d(db),sP=d(kq),sQ=d(a4),sR=d(ah),ti=[0,d(eH),377,29],th=d(eE),tf=d(ap),tg=d(kB),s_=d(X),tc=d(X),tb=d(gC),s9=d("= () -- AXIOM TO BE REALIZED"),ta=d(gC),s$=d(bn),td=d(ap),te=d(kB),s3=d(X),s6=d(gX),sZ=d(X),s0=d(X),s1=d(" () -- empty inductive"),s7=d(a4),s8=d(X),s2=d(ah),s4=d(bn),s5=d("data "),sV=d(k8),sW=d(gC),sY=d(X),sX=d(bn),sS=d(kR),sT=d(kW),sg=d(X),sf=d(eF),sh=d("\\"),rP=d("import qualified "),rQ=d('__ = Prelude.error "Logical or arity value used"'),rR=d("__ :: any"),rS=d(gH),rT=d("type Any = ()"),rU=d(gW),rV=d(gY),rW=d("type Any = GHC.Base.Any"),rX=d(gM),rY=d(gH),rZ=d("unsafeCoerce = IOExts.unsafeCoerce"),r0=d(kE),r1=d(gW),r2=d(gY),r3=d("unsafeCoerce = GHC.Base.unsafeCoerce#"),r4=d(kE),r5=d(gM),r6=d(gH),r7=d("import qualified IOExts"),r8=d(gW),r9=d(gY),r_=d("import qualified GHC.Base"),r$=d(gM),sa=d("import qualified Prelude"),sb=d(" where"),sc=d(bJ),sd=d('{- For Hugs, use the option -F"cpp -P -traditional" -}'),se=d("{-# OPTIONS_GHC -cpp -XMagicHash #-}"),rM=d(" -}"),rN=d("{- "),rL=d("-- "),rJ=c4([d(ld),d(kD),d(kr),d("data"),d("default"),d("deriving"),d(lc),d(kU),d(kZ),d("import"),d(et),d("infix"),d("infixl"),d("infixr"),d("instance"),d(gD),d(gV),d("newtype"),d(lf),d(k$),d(eC),d("where"),d(bq),d(V),d(kL),d("qualified"),d("hiding"),d(kv),d(kQ)]),tm=d(".hs"),tJ=d("type:unknown"),tK=d(u),tL=d("type:axiom"),tM=d(u),tN=d("right"),tO=d("left"),tP=d("type:arrow"),tQ=d(u),tR=d(gI),tS=d(Y),tT=d("type:glob"),tU=d(u),tY=d(Y),tZ=d("type:var"),t0=d(u),tV=d(Y),tW=d("type:varidx"),tX=d(u),t2=d("type:dummy"),t3=d(u),t1=[0,d(k7),64,25],uz=d(da),uA=d(Y),uB=d("fix:item"),uC=d(u),t4=d("expr:axiom"),t5=d(u),t6=d(Y),t7=d("expr:rel"),t8=d(u),t9=d(gI),t_=d("func"),t$=d("expr:apply"),ua=d(u),ub=d(da),uc=d(c6),ud=d(k6),ue=d(u),uf=d(da),ug=d("nameval"),uh=d(Y),ui=d("expr:let"),uj=d(u),uk=d(Y),ul=d("expr:global"),um=d(u),un=d(gI),uo=d(Y),up=d("expr:constructor"),uq=d(u),ur=d(kF),us=d("expr:tuple"),ut=d(u),uu=d("cases"),uv=d("expr"),uw=d("expr:case"),ux=d(u),uy=d(ks),uD=d("funcs"),uE=d("expr:fix"),uF=d(u),uG=d("msg"),uH=d("expr:exception"),uI=d(u),uJ=d("expr:dummy"),uK=d(u),uL=d(eA),uM=d("expr:coerce"),uN=d(u),uO=d("int"),uP=d("expr:int"),uQ=d(u),uR=d(da),uS=d("pat"),uT=d(kD),uU=d(u),uV=d("pat:wild"),uW=d(u),uX=d(kF),uY=d("pat:tuple"),uZ=d(u),u0=d(Y),u1=d("pat:rel"),u2=d(u),u3=d(c6),u4=d(Y),u5=d("pat:constructor"),u6=d(u),u7=d(da),u8=d(c6),u9=d(k6),u_=d(u),vz=[0,d(k7),251,29],vB=d(db),vC=d("  ]"),vD=d("    "),vE=d(": ["),vF=d("declarations"),vG=d(a4),vH=d(ch),vr=d(eA),vs=d(eC),vt=d(Y),vu=d("fixgroup:item"),vv=d(u),vg=d(ai),vh=d(eA),vi=d(c6),vj=d(Y),vk=d("decl:type"),vl=d(u),vm=d(eA),vn=d(eC),vo=d(Y),vp=d("decl:term"),vq=d(u),vw=d("fixlist"),vx=d("decl:fixgroup"),vy=d(u),u$=d("argtypes"),va=d(Y),vb=d("constructors"),vc=d(c6),vd=d(Y),ve=d("decl:ind"),vf=d(u),tB=d("used_modules"),tC=d("need_dummy"),tD=d("need_magic"),tE=d(Y),tF=d(gV),tG=d(u),tH=d(" */"),tI=d("/* "),tx=d(eu),ty=d(a4),tz=d(ey),tu=d(eu),tv=d(a4),tw=d(ey),tt=d(db),tr=d(a4),ts=d("{"),tq=d(kY),tn=d(ev),to=d(ew),vK=d(".json"),vL=[0,d(c5),30,18],vN=[0,d(c5),211,9],vV=[9,d(eE)],vR=[0,d(c5),316,9],vP=[0,d(c5),235,22],vQ=[0,d(c5),231,14],vO=d("reference not found in extracted structure."),vM=d("Extraction_plugin.Modutil.Found"),vW=d("Extraction_plugin.Modutil.RemainingImplicit"),wv=d('failwith "AXIOM TO BE REALIZED"'),ww=d(V),wx=d(aq),wz=[0,d(c_),255,8],wy=d("lazy "),wA=[0,d(c_),277,8],wB=d(k3),wC=d("Lazy.force"),wD=d(ko),wE=d(k0),wF=d(gG),wG=d(gP),wH=d("assert false"),wI=d(ai),wM=d(V),wJ=d(gG),wK=d(gP),wL=d(V),wN=d("Obj.magic"),wQ=[0,d(c_),314,8],wO=d(c9),wP=d(ez),wR=d(aq),wU=d(es),wT=d(ah),wS=d(lb),wV=d("{ "),wW=d(bq),wX=d(ev),wY=d(ew),wZ=d("else "),w0=d("then "),w1=d("if "),w2=d(eF),w3=d(gX),w8=d(" = function"),w6=d(ko),w7=d(" = match "),w4=d(a4),w5=d(ah),w_=d(eq),w9=d(gL),w$=d(kM),xY=d(k_),xZ=d("include module type of struct include "),x0=d(c7),x1=d(" : sig"),x2=d(bJ),x3=d(k_),x4=d("module type of struct include "),x5=d(eB),x6=d(bJ),x7=d(eB),x8=d(bJ),x9=d(ap),x_=d(ex),x$=d(ah),ya=d(ex),yb=d(k5),yc=d(kN),yd=d(kK),ye=d(c7),yg=d(X),yf=d(ep),yh=d(" with type "),yi=d(ap),yj=d(" with module "),yk=d(ap),yl=d("include "),ym=d(c7),yn=d(" = struct"),yo=d(bJ),yp=d(kY),yq=d(ap),yr=d(bJ),ys=d(ah),yt=d(bJ),yu=d(ap),yv=d(ex),yw=d(ah),yx=d(ex),yy=d(k5),yz=d(kN),yA=d(kK),yB=d(c7),yD=d(X),yC=d(kt),yE=d(c9),yF=d(ez),xV=d(ah),xU=d(le),xS=d(ah),xT=d(bn),xW=d(eB),xX=d("val "),xN=d(ah),xK=d(le),xM=d(ah),xL=d(bn),xO=d(ap),xQ=d(" x = x."),xR=d(" _"),xP=d(gS),xG=d(V),xJ=d(ai),xH=d(bn),xI=d(eq),xC=d(eq),xD=d(" Lazy.t"),xE=d(V),xF=d(ap),xz=d(es),xy=d(" : "),xx=d(lb),xA=d(" = { "),xB=d(bn),xu=d(k8),xv=d(ah),xw=d(bn),xs=d(kR),xt=d(kW),xn=d("* "),xp=d(" of "),xo=d(gX),xq=d(" unit (* empty inductive *)"),xr=d(ah),xk=d(ap),xl=d(aq),xm=d(ap),xj=d(eE),xg=d(ap),xh=d(kM),xi=d(eq),xc=d(" **)"),xd=d(eB),xe=d("(** val "),xa=[0,0,0],xb=[0,0,-100000],wq=d(ev),wr=d(ew),wj=d(V),wl=d(kw),wm=d(ep),wn=d(k1),wo=d("'a"),wp=d(V),wk=[0,d(c_),163,36],wi=d(V),wh=[0,d(c_),148,9],wb=d("let __ = let rec f _ = Obj.repr f in Obj.repr f"),wa=d("type __ = Obj.t"),v_=d(gG),v$=d(gP),v9=d("open "),v3=d(ah),v4=d(gS),v5=d(et),v1=d(X),v0=d(eF),v2=d("fun "),vY=d(gO),v7=c4([d("and"),d(kL),d("assert"),d("begin"),d(kr),d("constraint"),d(lc),d("done"),d("downto"),d(kU),d(c7),d("exception"),d("external"),d(ew),d(ks),d("fun"),d("function"),d("functor"),d(kZ),d(et),d("include"),d("inherit"),d("initializer"),d("lazy"),d(gD),d(kT),d("method"),d(gV),d("mutable"),d("new"),d("object"),d(lf),d("open"),d("or"),d("parser"),d("private"),d("rec"),d(ep),d(kt),d(k$),d("to"),d(ev),d("try"),d(eC),d("val"),d("virtual"),d("when"),d("while"),d("with"),d("mod"),d("land"),d("lor"),d("lxor"),d("lsl"),d("lsr"),d("asr"),d(kv),d(bq),d(V)]),we=c4([61,60,62,64,94,59,38,43,45,42,47,36,37]),wf=c4([33,36,37,38,42,43,45,46,47,58,60,61,62,63,64,94,124,gT]),wg=[0,d("::"),[0,d(ch),0]],yH=[0,d(".mli")],yI=d(gR),yY=d('error "AXIOM TO BE REALIZED"'),yZ=d(gS),y2=[0,d(eG),93,1],y0=d("`"),y1=d("delay "),y3=d("Cannot handle tuples in Scheme yet."),y6=d("Cannot handle general patterns in Scheme yet."),y4=d(la),y5=d(k0),y7=d(lg),y8=d(V),y9=d(kI),y_=d(ch),y$=[0,d(eG),146,11],za=d(X),zb=d(c9),zc=d(c9),zd=d("(("),ze=d("letrec "),zi=[0,d(eG),215,29],zh=d(eE),zg=d(kx),zf=d(kx),yX=d("@ "),yU=d("lambdas "),yV=d("lambda "),yW=[0,d(eG),50,10],yP=d("(define __ (lambda (_) __))\n\n"),yQ=d('(load "macros_extr.scm")\n\n'),yR=d(";; available at http://www.pps.univ-paris-diderot.fr/~letouzey/scheme\n"),yS=d(";; This extracted scheme code relies on some additional macros\n"),yN=d(";; "),yK=c4([d("define"),d(gD),d("lambda"),d("lambdas"),d(kT),d("apply"),d("car"),d("cdr"),d(lg),d("delay"),d(la),d(bq),d(V)]),zm=d(".scm"),zx=[0,d(br),273,8],zz=[0,d(br),352,16],zA=[0,d(br),410,6],zG=[0,0,0],Ab=d("No ongoing proof"),z_=[0,1],z2=d("This command only works with OCaml extraction"),z3=d(gR),z4=d("testextraction"),z5=d(lh),z6=d(gR),z7=d(".cmo"),z8=d(".cmi"),z9=d("Extracted code successfully compiled"),zU=d(lh),zV=d("-c"),zW=d("-I"),zX=d("ocamlc"),z0=d(" failed with exit code "),z1=d(k4),zS=d(" failed with error "),zT=d(k4),zQ=[0,1],zO=[0,d(br),704,32],zN=[0,d(br),690,11],zM=[0,0,0],zL=d("(** User defined extraction *)"),zK=[0,d(br),663,9],zH=[0,d(br),639,11],zF=d("[ \t\n]+"),zD=d("Extraction: provided filename is not a valid identifier"),zu=[0,d(br),c8,18],zn=d("CONSTANT"),zo=d("INCLUDE"),zp=d("INDUCTIVE"),zq=d("MODULE"),zr=d("MODULE TYPE"),zs=d("No extraction of toplevel Include yet."),zv=d("Extraction_plugin.Extract_env.Impossible"),zB=d("Main"),AK=d('The spelling "OCaml" should be used instead of "Ocaml".'),AF=d(kS),AG=d(kJ),AH=d(k9),AI=d(kz),Aq=d("mlname"),AD=d("int_or_id"),AL=d("deprecated"),AM=d("deprecated-ocaml-spelling"),AP=d("Ocaml"),AS=d(kS),AV=d(kJ),AY=d(k9),A1=d(kz),A4=d("language"),A9=d("TestCompile"),A_=d(C),Bd=d(C),Bh=d(C),Bi=d(kP),Bm=d(C),Bq=d(C),Bu=d(C),Bv=d("Separate"),Bz=d("SeparateExtraction"),BD=d(kp),BE=d(C),BI=d("ExtractionLibrary"),BM=d(kp),BN=d(C),BO=d(kP),BS=d("RecursiveExtractionLibrary"),BW=d("Language"),BX=d(C),B1=d("ExtractionLanguage"),B5=d(gF),B6=d(C),B_=d("ExtractionInline"),Cc=d("NoInline"),Cd=d(C),Ch=d("ExtractionNoInline"),Ck=[0,d(k2),[0,d(C),[0,d(gF),0]]],Co=d("PrintExtractionInline"),Cr=[0,d(kV),[0,d(C),[0,d(gF),0]]],Cv=d("ResetExtractionInline"),Cz=[0,d(eu),0],CA=d(ey),CC=d("Implicit"),CD=d(C),CH=d("ExtractionImplicit"),CL=d(gE),CM=d(C),CQ=d("ExtractionBlacklist"),CT=[0,d(k2),[0,d(C),[0,d(gE),0]]],CX=d("PrintExtractionBlacklist"),C0=[0,d(kV),[0,d(C),[0,d(gE),0]]],C4=d("ResetExtractionBlacklist"),C8=d(gQ),C$=d(kG),Da=d(gK),De=d("ExtractionConstant"),Di=d(gQ),Dk=d(kG),Dl=d("Inlined"),Dm=d(gK),Dq=d("ExtractionInlinedConstant"),Du=d(eu),Dw=d(ey),Dy=d(gQ),DA=d("Inductive"),DB=d(gK),DF=d("ExtractionInductive"),DI=[0,d("Show"),[0,d(C),0]],DM=d("ShowExtraction"),li=v[4],lj=v[5],lk=v[7],ll=v[8],lm=v[10],ln=v[12],lo=v[13],lp=v[15],lq=v[16],lr=v[17],ls=v[21],lt=v[26],lu=v[27],lv=v[28],lw=v[29],lx=v[30],ly=v[33],lz=v[34],lA=v[36],lB=v[37],lC=v[38];function
...
dx=[bp,o_,bl(0)],q=[bp,o$,bl(0)],a8=c(f[1][6],pa),bT=c(f[1][6],pb),h7=[0,a8];function
bw(b){if(b){var
...
p=h-c(e[17][1],m)|0,f=a(j[6],0,p),q=function(a){return i(d,a)},r=a(e[17][68],q,m),s=function(a){return x(f,a)},t=a(e[17][68],s,r),u=cC(f),v=dK(k,a(e[18],t,u)),w=[1,x(f,n),v];return ab(a(e[17][eD],f,g),w)}}if(l(d,b)){var
...
O=a(j[6],0,d-b|0),A=a(e[17][kO],O,s),B=a(e[17][68],as,A),C=as(0),p=by([0,z,a9([0,B,C])]),n=by([0,C,F]),q=function(d){if(0===o[1])return aI(p,c(e[17][5],d));var
b=cy(z)[2];if(typeof
...
r=(b+l|0)-d|0,E=a(e[17][kO],r,f),R=cD(r,E),S=function(a){return x(r,a)},T=a(e[17][68],S,D);return aI(n,bW(q(a(e[18],T,R)),E))}throw[0,m,rn]}function
cT(k,j,i,h,f,b){var
...
m=a(e[17][68],l,k),f=a(n[92],c,h),b=d-j|0,o=f[2],p=f[1],q=a(e[17][eD],b,m),s=a(e[18],q,p),t=a(e[17][53],1,b),u=a(e[17][14],n[10],t);return[0,s,cN(a(n[av][1],b,o),u)]}function
...
f=0;if(!f)var
l=C,F=B;var
G=c(e[17][1],l),H=a(e[17][eD],G,k),I=a(e[17][a3],G,A),X=I[1],Y=a9([0,I[2],S]),Z=g(e[17][15],aK[5],aK[1],X);function
...
d=jq(g)}vX(d);return d}ag(kH,[0,d$,gb,aG,d8,f$,jl,jm,gc,cU,jn,b_],"Extraction_plugin__Modutil");function
js(d){var

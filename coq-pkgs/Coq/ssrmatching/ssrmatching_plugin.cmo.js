...
h=p.caml_get_global_data(),hh=[0,4],hi=[0,1,9],hj=[0,1,9],hk=[0,4],hl=[0,1,9],aA=d(bo),ab=[0,[0,0,0]],b1=[0,d(bo),d(cc)],T=h.Assert_failure,n=h.Names,aD=h.Loc,r=h.Ltac_plugin,z=h.Proofview,l=h.Genarg,M=h.Pervasives,c=h.Pp,m=h.Tacmach,f=h.EConstr,aV=h.Global,g=h.Evd,t=h.Geninterp,S=h.Ftactic,D=h.CAst,q=h.CErrors,e=h.Term,bF=h.Typeclasses,bN=h.Evar,j=h.Util,R=h.Ppconstr,ak=h.Option,av=h.Context,ap=h.Not_found,a8=h.Vars,az=h.Goal,aB=h.Environ,as=h.Evarutil,k=h.Pcoq,bA=h.Constrexpr_ops,bO=h.Termops,bH=h.Recordops,bD=h.Evarconv,a3=h.Unification,aG=h.Printf,at=h.Unix,H=h.Genintern,aU=h.Printer,bw=h.Constrintern,bs=h.Feedback,B=h.CLexer,aR=h.Mltop,bu=h.Goptions,g6=h.Tacticals,gQ=h.Tactics,fs=h.Stdarg,dQ=h.CArray,dH=h.Failure,dB=h.Pretype_errors,dw=h.Invalid_argument,ds=h.Globnames,dl=h.Reductionops,c9=h.Reduction,cM=h.Glob_ops,ct=h.CamlinternalLazy,cp=a(B[6],0);a(aR[12],aA);var
hd=[0,d(Y),1,0],hc=d("$arg"),he=[0,d("ssrinstancesoftpat")],hf=d(cb),g9=d("Extension: cannot occur"),g2=d("matches:"),g3=d("instance:"),g7=d("Not supported"),g0=[0,1],g1=[0,1],g4=d("BEGIN INSTANCES"),g5=d("END INSTANCES"),gX=d(cc),gR=d(cl),gP=d("selected"),gB=d("matching impacts evars"),gz=d(" does not match any subterm of the goal"),gA=d(co),gx=[0,1],gt=[0,[0,1,0]],gu=[0,[0,0,[0,1,0]]],gs=d("pattern without redex."),gr=[0,0],gn=[0,d(Y),1214,56],gj=d("in the pattern?"),gk=d('Does the variable bound by the "in" construct occur '),gl=d(" did not instantiate ?"),gm=d("Matching the pattern "),gp=[0,1],gq=[0,1],go=[0,1],gh=d("typed as: "),gg=d("decoded as: "),gf=[0,d(Y),1140,54],gc=d(b8),gd=d(bi),ge=d(an),gb=[0,d(Y),1100,63],f$=d("."),ga=d("bad encoding for pattern "),f_=d(" in ist: "),f9=d("interpreting: "),f8=d(":"),fu=d(cm),fv=d("@"),fr=[0,d(Y),1e3,12],fq=d(b$),et=d(b$),es=d(b8),er=d("globbing pattern: "),eu=d("( _ as _ )"),ev=d("( _ as _ in _ )"),ew=d("( _ in _ )"),ex=d("( _ in _ in _ )"),ey=d(an),eA=d(an),eB=d(an),eD=d(an),eC=d("where are we?."),ez=d(an),eE=d(bi),eF=d(bi),eh=d(am),ei=d(x),ej=d(x),ek=d(am),el=d(x),em=d(x),en=d(x),eo=d(bk),d$=d(am),ea=d(x),eb=d(x),ec=d(am),ed=d(x),ee=d(x),ef=d(x),eg=d(bk),d3=d(am),d4=d(x),d5=d(x),d6=d(am),d7=d(x),d8=d(x),d9=d(x),d_=d(bk),d1=d("matches but type classes inference fails"),d2=d("does not match any subterm of the goal"),d0=d(b_),dY=d("are equal to the "),dZ=d("all matches of "),dX=d("companion function never called."),dR=d("of "),dS=d(" of the "),dW=d(" of"),dT=d(" occurence"),dU=d(" < "),dV=d("Only "),dL=d(ca),dM=d(ck),dJ=d(ca),dK=d(ck),dO=d("term "),dP=d(co),dN=d(b_),dI=d(ch),dF=d(ch),dv=d("incomplete ise in match_upats_FO."),dx=d("IN FO."),dr=[0,d(Y),506,13],dm=d(x),dn=d("indeterminate "),dp=d("indeterminate pattern"),df=d("RHS"),de=d("LHS"),db=[0,1],c7=[0,[11,d(aN),[2,[0,0,39],[12,32,[4,0,[0,1,10],0,[12,32,[8,0,[0,1,9],[0,4],[12,32,[8,0,[0,1,9],[0,4],[12,32,[8,0,hi,hh,0]]]]]]]]]],d(ci)],c6=[0,d(Y),201,26],cY=[0,[11,d(aN),[2,[0,1,39],[11,d(" ---------- --------- --------- ---------"),0]]],d("!! %39s ---------- --------- --------- ---------")],cZ=d("average"),c0=d("max"),c1=d(cg),c2=d("#calls"),c3=d("function"),c4=[0,[11,d(aN),[2,[0,0,39],[12,32,[2,[0,1,10],[12,32,[2,[0,1,9],[12,32,[2,[0,1,9],[12,32,[2,hj,0]]]]]]]]]],d("!! %-39s %10s %9s %9s %9s")],cV=[0,d(Y),194,26],cS=d(cg),cT=[0,[11,d(aN),[2,[0,0,39],[12,32,[4,0,[0,1,10],0,[12,32,[8,0,[0,1,9],[0,4],[12,32,[8,0,[0,1,9],[0,4],[12,32,[8,0,hl,hk,0]]]]]]]]]],d(ci)],cK=d("have: mixed C-G constr."),cL=d("have: mixed G-C constr."),cH=[0,0],cG=[12,0,0,0],cF=d("not a CRef."),cz=d("$"),cx=d(")"),cy=d(cm),cs=d("SSR: "),cr=[0,d("ssrmatching")],hg=d("SSRMATCHINGDEBUG"),cu=[0,d("Debug"),[0,d("SsrMatching"),0]],cv=d("ssrmatching debugging"),cI=[13,0,0,0],cO=[0,d("SsrMatchingProfiling"),0],cP=d("ssrmatching profiling"),c8=d("Ssrmatching.NoProgress"),c_=d("unif_EQ_args"),dd=d("Ssrmatching.NoMatch"),di=d("_"),dt=d("Ssrmatching.FoundUnif"),dy=d("match_upats_FO"),dC=d("match_upats_HO"),eq=d("rpatternty"),eH=d(bl),eN=d(bl),eU=d(ad),eY=d(ad),e3=d(ad),e6=d(ad),e_=d(ad),fb=d(ad),fg=d(ad),fj=d("as"),fn=d(bl),fw=d("ssrtermkind"),fx=d(bq),fB=d(bq),fG=d(cf),fK=d(bq),fO=d(bp),fU=d(bp),fZ=d(cf),f3=d(bp),gG=d(b7),gM=d(b7),gU=d(cl),gY=d(bo),ha=d(cb),cq=q[6];function
Q(a){return b(cq,a,cr)}function
br(d,b){var
e=a(c[3],b);return i(q[6],d,[0,b],e)}var
aS=bs[6],ao=[0,function(a){return 0}];function
aT(d){var
e=p.caml_obj_tag(d),f=250===e?d[1]:ac===e?a(ct[2],d):d,g=a(c[3],cs),h=b(c[12],g,f);return b(bs[10],0,h)}try{p.caml_sys_getenv(hg);ao[1]=aT}catch(a){a=v(a);if(a!==ap)throw a}function
...
p(b,d,c,a){return o(ap,b,m,a,q)}return h(c,o(an,b,h(n,t),i,p))}),ar=a(ao,0)[3][2];a(am,0);a(ak,0);return[0,aq,ar];case
5:var
z=l[2],as=l[3],A=h(d,l[1]),v=h(d,as),at=y(z),au=a(f[8],A),S=aa(j,d,a(f[8],z),au),U=G(0,0,0,k,ab,m(gq,j,k,[0,S,h(S,v)],0,N)),av=U[2],aw=U[1],V=G(0,0,0,d,r,m(0,j,d,[0,d,z],0,N)),ax=V[2],ay=V[1],az=o(aw,j,p,1,function(b,k,r,j){var
l=a(f[8],v),m=a(f[8],k),c=aa(b,a(g[ae],d),m,l),e=x(c,at,v),i=e[1],n=e[2];function
p(b,j,g,d){var
e=a(f[8],A),c=h(aa(b,i,a(f[8],n),e),A);return o(q,b,c,c,d)}return h(c,o(ay,b,h(i,v),j,p))});a(ax,0);return[0,az,a(av,0)[3][2]];case
0:case
1:var
...
B=0;if(!B)var
F=ab;var
H=G(0,w,0,k,F,m(0,j,k,[0,X,W],0,N)),Y=H[2],Z=o(H[1],j,p,1,q);return[0,Z,a(Y,0)[3][2]];default:var
...
r(a,c){return b(q,a,n)}return h(e,o(af,c,h(p,s),j,r))});a(ad,0);return[0,ag,a($,0)[3][2]]}}var
aA=g[b9];return[0,o(q,j,p,p,1),aA]}function
bX(d,k,b){var
...
var
h=1,g=c;var
b=[0,0],i=bW(m,f,l,k,[0,d],g,function(g,c,f,d){a9(b,function(a){return c});return h?a(e[bm],(d+j|0)-1|0):c}),n=i[2],o=i[1],p=0===b[1]?bX(0,f,d)[1]:a_(b);return[0,[0,p,n],o]}function
bb(g,f,e,d,c,b,a){return bJ(g,0,f,e,d,c,b,a)}function
gv(g,f,e,d,c,b,a){return bW(g,f,e,d,c,b,a)[1]}function
gw(h,q,p,d,n,c,m,l){var
r=c[2],s=c[1],t=a(f[w][1],n),u=a(f[w][1],q),v=a(g[ae],s),i=bb(0,h,d,[0,v,a(f[w][1],r)],m,0,t),j=G(0,gx,0,d,p,[0,i[1],[0,i[2],0]]),x=j[2],y=j[1],z=o(y,h,u,l,function(c,b,a){return e[bm]}),k=a(x,0),b=k[3],A=b[3],B=b[2],C=b[1],D=a(f[8],k[1]),E=a(f[8],z);return[0,C,B,a(f[8],A),E,D]}function
gy(m,l,s,d,k){var
e=k[2],n=k[1];try{var
h=gw(m,l,s,d,e,[0,n,e],N,1),p=h[1],G=h[4],H=h[3],I=h[2];if(p!==d)var
J=a(c[3],gB),r=i(q[6],0,0,J);else
var
...
t=a(c[3],gz),u=F(a(f[w][1],e)),x=a(c[3],gA),y=b(c[12],x,u),z=b(c[12],y,t);return a(Q(0),z)}throw h}}function
gC(b,e,d){var
f=a(m[2],b),g=a(m[8],b),c=gy(g,a(m[7],b),e,f,d);return[0,c[1],c[2][2]]}function
gD(a){return[0,32,[0,b(D[1],0,[0,[0,a],0]),0]]}function
gE(c){var
a=c[2],b=a[2],d=a[1][1],e=b?12===b[1][1][0]?1:0:13===d[0]?1:0;return e?1:0}function
gF(d,c,b,a){return ai(a[2])}function
bZ(d,c,b,a){return ai(a)}var
K=a(l[2],gG);function
gH(a,b){return[0,a,bR(a,b)]}b(H[9],K,gH);function
gI(b,a){return a}b(H[10],K,gI);function
gJ(e,d){function
c(f){var
g=a(z[63][1],f);function
h(b){return[0,a(m[2],b),[0,e,d]]}var
c=b(m[48][3],h,g),i=c[2],j=c[1],k=a(l[6],K),n=a(t[2],k),o=b(t[1][8],n,i),p=a(S[1],o),q=a(z[61][1],j);return b(z[15],q,p)}return a(S[6],c)}b(t[6],K,gJ);b(t[3],K,0);b(k[11],K,ax);o(r[2][1],K,bZ,bZ,gF);var
gK=[0,ax,0];function
gL(c){var
d=c[2],e=a(l[4],K);return[0,b(l[7],e,d)]}i(r[9][5],gM,gL,gK);function
gN(d,c){var
...
gS=[0,function(p,c){var
d=c[1],e=a(n[1][6],gR),h=b(n[1][11][22],e,d),k=a(l[6],K),j=b(r[12][2][7],k,h);function
o(c){var
q=b0(j[1],c,j[2]),r=a(m[2],c),s=a(m[7],c),t=a(f[w][1],s),e=bY(0,a(aV[2],0),r,t,q,ab,1),u=e[2],h=a(f[8],e[1][1]),v=a(f[8],u),d=b(m[16],c,h),k=d[2],l=d[1],o=a(g[69],c),p=b(m[3],o,l),x=[0,[0,a(n[1][6],gP)],h,k,v],y=a(f[20],x),A=i(gQ[3],0,y,2);return b(z[67][8],A,p)}return a(z[67][1],o)}];i(r[6][9],0,b1,gS);var
gT=[31,b(aD[10],0,[0,[0,b1,0],0])],gV=[28,[0,[0,[0,a(n[1][6],gU)],0],gT]];function
gW(c){var
b=a(n[1][6],gX);return o(r[6][4],1,0,b,gV)}b(aR[19],gW,gY);function
gZ(n,l,d){var
p=a(m[7],d),g=a(m[2],d),h=a(m[8],d),q=a(f[w][1],p),i=bV(n,d,l,0),j=i[2],r=i[1];if(0===j[0])var
e=j[1];else
var
x=a(c[3],g7),e=a(Q(0),x);var
s=0,k=bb(0,h,g,[0,r,e],function(a,b){return 1},s,e),t=G(g1,g0,0,g,0,[0,k[1],[0,k[2],0]])[1];function
u(t,e,d,s){var
f=a(aC,d),g=a(c[13],0),h=a(c[3],g2),i=a(c[13],0),j=a(aC,e),k=a(c[13],0),l=a(c[3],g3),m=b(c[12],l,k),n=b(c[12],m,j),o=b(c[12],n,i),p=b(c[12],o,h),q=b(c[12],p,g),r=b(c[12],q,f);b(aS,0,b(c[26],1,r));return d}b(aS,0,a(c[3],g4));try{for(;;){o(t,h,q,1,u);continue}}catch(e){e=v(e);if(e===C){b(aS,0,a(c[3],g5));return a(g6[1],d)}throw e}}var
g8=0,g_=[0,function(c){if(c)if(!c[2]){var
d=c[1],e=a(l[6],A),f=b(r[12][2][7],e,d);return function(b){function
c(a){return gZ(b,f,a)}return a(z[67][1],c)}}return a(M[2],g9)},g8],g$=a(j[19][12],g_);i(r[6][9],0,[0,aA,ha],g$);function
hb(g){var
c=0,d=0,e=[0,a(n[1][7],hc)];if(0===A[0]){var
f=[0,[0,he,[0,[1,b(aD[10],0,[0,[5,[0,A[1]]],e])],d]],c];return i(r[9][4],[0,aA,hf],0,f)}throw[0,T,hd]}b(aR[19],hb,aA);a(B[5],cp);var
b2=[0,aW,aL,A,aM,O,ai,ax,V,C,ag,ep,bX,b0,bV,gv,bY,ah,bb,G,gC,fp,a9,a_,aa,dc,fo,_,gi,gE,gD,F,gN,gO,bt,bB];b6(242,b2,"Ssrmatching_plugin.Ssrmatching");b6(243,[0,b2],"Ssrmatching_plugin");return});
